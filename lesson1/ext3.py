...
plt.xlabel('Exercise Duration (Hours)', color='blue', fontstyle='italic', fontfamily='serif')
plt.ylabel('Calories Burned', color='orange', fontstyle='italic', fontfamily='monospace')
